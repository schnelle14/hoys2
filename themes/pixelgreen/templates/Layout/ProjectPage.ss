			...
			<ul>
				...
				<li>
					...
					<a class="link_label link_to_fancy" href="#project_gallery">
						<% _t('viewGallery','View Gallery') %>
					</a>
				</li>
				<% end_if %>
				<% if pdfExists %>
				<li><a href="$PdfDocument.Link"><img src="themes/pixelgreen/images/icon_pdf.png" alt=""/></a>
					<a class="link_label" href="$PdfDocument.Link">
						<% _t('downloadPDF','Download PDF') %>
					</a>
				</li>
				<% end_if %>
				<li><a href="javascript:printDiv()"><img src="themes/pixelgreen/images/icon_print.png" alt=""/></a>
					<a class="link_label" href="javascript:printDiv()">
						<% _t('print','Print') %>
					</a>
				</li>
			</ul>
...
<div class="more_projects">
	<h3><% _t('moreProjects','MORE PROJECTS') %></h3>
